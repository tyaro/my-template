...
- ~~**アプリ内文言の日本語ハードコード**（テンプレートアプリ層のみ）~~:
  **2026-07-22 に方針転換** — template-scope §4.3 の i18n 非導入決定を覆し、UI 多言語化
  （英語先行）を導入する（[adoption-plan-2026-07.md](adoption-plan-2026-07.md) AD-6 /
  [i18n-plan.md](i18n-plan.md)）。外国人労働者増を実例トリガとする。
